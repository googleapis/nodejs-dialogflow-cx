...
describe('v3.IntentsClient', () => {
    ...
    describe('getIntent', () => {
        it('invokes getIntent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.GetIntentRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.Intent());
    ...
    describe('createIntent', () => {
        it('invokes createIntent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.CreateIntentRequest());
            request.parent = '';
    ...
    describe('updateIntent', () => {
        it('invokes updateIntent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.UpdateIntentRequest());
            request.intent = {};
            request.intent.name = '';
    ...
    describe('deleteIntent', () => {
        it('invokes deleteIntent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.DeleteIntentRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listIntents', () => {
        it('invokes listIntents without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.ListIntentsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
