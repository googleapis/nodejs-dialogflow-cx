...
describe('v3beta1.TransitionRouteGroupsClient', () => {
  it('has servicePath', () => {
    const servicePath =
      transitionroutegroupsModule.v3beta1.TransitionRouteGroupsClient
        .servicePath;
    assert(servicePath);
  });
  ...
  it('has port', () => {
    const port =
      transitionroutegroupsModule.v3beta1.TransitionRouteGroupsClient.port;
    assert(port);
    ...
    it('invokes getTransitionRouteGroup without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTransitionRouteGroup(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.ITransitionRouteGroup | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listTransitionRouteGroupsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroup
          ) => {
