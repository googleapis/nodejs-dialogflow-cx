...
describe('v3beta1.SessionEntityTypesClient', () => {
  describe('Common methods', () => {
    it('has servicePath', () => {
      const servicePath =
        sessionentitytypesModule.v3beta1.SessionEntityTypesClient.servicePath;
      assert(servicePath);
    });

    it('has apiEndpoint', () => {
      const apiEndpoint =
        sessionentitytypesModule.v3beta1.SessionEntityTypesClient.apiEndpoint;
      assert(apiEndpoint);
    });

    it('has port', () => {
      const port =
        sessionentitytypesModule.v3beta1.SessionEntityTypesClient.port;
      assert(port);
    ...
    it('invokes getSessionEntityType without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getSessionEntityType(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3beta1.ISessionEntityType | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listSessionEntityTypesStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.dialogflow.cx.v3beta1.SessionEntityType
          ) => {
