...
describe('v3.SecuritySettingsServiceClient', () => {
  describe('Common methods', () => {
    it('has servicePath', () => {
      const servicePath =
        securitysettingsserviceModule.v3.SecuritySettingsServiceClient
          .servicePath;
      assert(servicePath);
    });
    ...
    it('has port', () => {
      const port =
        securitysettingsserviceModule.v3.SecuritySettingsServiceClient.port;
      assert(port);
    ...
    it('invokes createSecuritySettings without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.createSecuritySettings(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.dialogflow.cx.v3.ISecuritySettings | null
          ) => {
            if (err) {
              reject(err);
            } else {
