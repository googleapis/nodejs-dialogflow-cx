...
describe('v3beta1.AgentsClient', () => {
    ...
    describe('getAgent', () => {
        it('invokes getAgent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetAgentRequest', ['name']);
    ...
    describe('createAgent', () => {
        it('invokes createAgent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateAgentRequest', ['parent']);
    ...
    describe('updateAgent', () => {
        it('invokes updateAgent without error', async () => {
            ...
            request.agent ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateAgentRequest', ['agent', 'name']);
    ...
    describe('deleteAgent', () => {
        it('invokes deleteAgent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteAgentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('validateAgent', () => {
        it('invokes validateAgent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ValidateAgentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getAgentValidationResult', () => {
        it('invokes getAgentValidationResult without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetAgentValidationResultRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dialogflow.cx.v3beta1.AgentValidationResult()
    ...
    describe('exportAgent', () => {
        it('invokes exportAgent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ExportAgentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('restoreAgent', () => {
        it('invokes restoreAgent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RestoreAgentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listAgents', () => {
        it('invokes listAgents without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListAgentsRequest', ['parent']);
            request.parent = defaultValue1;
