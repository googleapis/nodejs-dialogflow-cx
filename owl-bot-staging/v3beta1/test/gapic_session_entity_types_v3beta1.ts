...
describe('v3beta1.SessionEntityTypesClient', () => {
    ...
    describe('getSessionEntityType', () => {
        it('invokes getSessionEntityType without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.GetSessionEntityTypeRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.SessionEntityType());
    ...
    describe('createSessionEntityType', () => {
        it('invokes createSessionEntityType without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.CreateSessionEntityTypeRequest());
            request.parent = '';
    ...
    describe('updateSessionEntityType', () => {
        it('invokes updateSessionEntityType without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.UpdateSessionEntityTypeRequest());
    ...
    describe('deleteSessionEntityType', () => {
        it('invokes deleteSessionEntityType without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.DeleteSessionEntityTypeRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listSessionEntityTypes', () => {
        it('invokes listSessionEntityTypes without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.ListSessionEntityTypesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
