...
describe('v3beta1.FlowsClient', () => {
    ...
    describe('createFlow', () => {
        it('invokes createFlow without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.Flow());
    ...
    describe('validateFlow', () => {
        it('invokes validateFlow without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.FlowValidationResult());
