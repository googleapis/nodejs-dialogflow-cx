...
describe('v3beta1.SessionsClient', () => {
    ...
    describe('detectIntent', () => {
        it('invokes detectIntent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.DetectIntentRequest());
            request.session = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.DetectIntentResponse());
    ...
    describe('matchIntent', () => {
        it('invokes matchIntent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.MatchIntentRequest());
            request.session = '';
            const expectedHeaderRequestParams = "session=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.MatchIntentResponse());
    ...
    describe('fulfillIntent', () => {
        it('invokes fulfillIntent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.FulfillIntentRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.FulfillIntentResponse());
    ...
    describe('streamingDetectIntent', () => {
        it('invokes streamingDetectIntent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.StreamingDetectIntentRequest());
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.StreamingDetectIntentResponse());
        ...
        it('invokes streamingDetectIntent with error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.StreamingDetectIntentRequest());const expectedError = new Error('expected');
