...
describe('v3beta1.VersionsClient', () => {
    ...
    describe('getVersion', () => {
        it('invokes getVersion without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.Version());
    ...
    describe('compareVersions', () => {
        it('invokes compareVersions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.CompareVersionsRequest());
            request.baseVersion = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.CompareVersionsResponse());
