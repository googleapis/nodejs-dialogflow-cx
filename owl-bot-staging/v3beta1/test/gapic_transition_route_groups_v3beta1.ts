...
describe('v3beta1.TransitionRouteGroupsClient', () => {
    ...
    describe('getTransitionRouteGroup', () => {
        it('invokes getTransitionRouteGroup without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.GetTransitionRouteGroupRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroup());
            ...
            assert((client.innerApiCalls.getTransitionRouteGroup as SinonStub)
    ...
    describe('createTransitionRouteGroup', () => {
        it('invokes createTransitionRouteGroup without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.CreateTransitionRouteGroupRequest());
            request.parent = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createTransitionRouteGroup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateTransitionRouteGroup', () => {
        it('invokes updateTransitionRouteGroup without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.UpdateTransitionRouteGroupRequest());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateTransitionRouteGroup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteTransitionRouteGroup', () => {
        it('invokes deleteTransitionRouteGroup without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.DeleteTransitionRouteGroupRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteTransitionRouteGroup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listTransitionRouteGroups', () => {
        it('invokes listTransitionRouteGroups without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3beta1.ListTransitionRouteGroupsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listTransitionRouteGroups as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
