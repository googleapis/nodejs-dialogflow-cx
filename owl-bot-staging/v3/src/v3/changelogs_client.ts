...
import {Callback, CallOptions, Descriptors, ClientOptions, PaginationCallback, GaxCall, LocationsClient, LocationProtos} from 'google-gax';
 ...
 */
  listChangelogsStream(
    ...
    return this.descriptors.page.listChangelogs.createStream(
      this.innerApiCalls.listChangelogs as gax.GaxCall,
      request,
      callSettings
    );
  }
