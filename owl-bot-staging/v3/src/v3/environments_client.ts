...
export class EnvironmentsClient {
  ...
  initialize() {
    ...
    const environmentsStubMethods =
        ['listEnvironments', 'getEnvironment', 'createEnvironment', 'updateEnvironment', 'deleteEnvironment', 'lookupEnvironmentHistory', 'runContinuousTest', 'listContinuousTestResults'];
