...
describe('v3.EnvironmentsClient', () => {
    ...
    describe('getEnvironment', () => {
        it('invokes getEnvironment without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.Environment());
    ...
    describe('deployFlow', () => {
        it('invokes deployFlow without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.cx.v3.DeployFlowRequest());
            request.environment = '';
            const expectedHeaderRequestParams = "environment=";
            const expectedOptions = {
                otherArgs: {
