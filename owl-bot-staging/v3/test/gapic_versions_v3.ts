...
describe('v3.VersionsClient', () => {
    ...
    describe('updateVersion', () => {
        it('invokes updateVersion without error', async () => {
            ...
            request.version ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateVersionRequest', ['version', 'name']);
    ...
    describe('compareVersions', () => {
        it('invokes compareVersions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CompareVersionsRequest', ['baseVersion']);
    ...
    describe('createVersion', () => {
        it('invokes createVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateVersionRequest', ['parent']);
    ...
    describe('loadVersion', () => {
        it('invokes loadVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('LoadVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
