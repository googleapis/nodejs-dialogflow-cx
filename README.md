...
| Revive-previous-session-state | [source code](https://github.com/googleapis/nodejs-dialogflow-cx/blob/main/samples/revive-previous-session-state.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/googleapis/nodejs-dialogflow-cx&page=editor&open_in_editor=samples/revive-previous-session-state.js,samples/README.md) |
