...
export class TransitionRouteGroupsClient {
   ...
   *     Follows the structure of `transition_route_groups_client_config.json`.
   ...
   *   {@link google.cloud.dialogflow.cx.v3beta1.TransitionRoute|TransitionRoute} is language dependent.
   *
