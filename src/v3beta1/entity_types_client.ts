...
export class EntityTypesClient {
   ...
   *   The first element is Array of [EntityType]{@link google.cloud.dialogflow.cx.v3beta1.EntityType} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListEntityTypesRequest]{@link google.cloud.dialogflow.cx.v3beta1.ListEntityTypesRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListEntityTypesResponse]{@link google.cloud.dialogflow.cx.v3beta1.ListEntityTypesResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  listEntityTypes(
